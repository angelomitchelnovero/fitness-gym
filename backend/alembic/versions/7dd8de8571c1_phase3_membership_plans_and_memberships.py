...
Create Date: 2026-08-25 01:01:17.403936
...
def upgrade() -> None:
    ...
    op.alter_column('users', 'role',
               ...
               type_=sa.Enum('ADMIN', 'CUSTOMER', name='user_role', native_enum=False, length=20),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('users', 'role',
               existing_type=sa.Enum('ADMIN', 'CUSTOMER', name='user_role', native_enum=False, length=20),
               type_=postgresql.ENUM('ADMIN', 'CUSTOMER', name='user_role'),
               existing_nullable=False)
